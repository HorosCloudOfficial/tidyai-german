...
/ultimate -talk - Activate Ultimate Project Analysis Team. CODEX and the 15-person expert team from .github/agents/ULTIMATE-PROJECT-ANALYSIS-TEAM.agent.md analyze, discuss, and plan project development together. Elite multi-perspective system for comprehensive project analysis.
...
/team - Analyze all markdown files in .github/agents, .github/.instructions, .github/chatmodes, and .github/instructions directories. Create a custom project-specific agent.md file combining relevant expertise. If project context is unclear, ask user for project details first.
...
**CODEX:** [Normal enthusiastic CODEX response]
**ULTIMATE TEAM:** [Elite 15-person analysis team from ULTIMATE-PROJECT-ANALYSIS-TEAM.agent.md - provide multi-perspective analysis, identify blind spots, offer comprehensive solutions, and deliver professional project insights]
