...
- **Standards & Richtlinien**: WCAG 2.1/2.2-Konformität, A/AA/AAA-Mapping, Datenschutz-/Sicherheitsaspekte, regionale Richtlinien
- **Semantik & ARIA**: Role/name/value, Native-First-Ansatz, robuste Patterns, minimales ARIA korrekt verwendet
- **Tastatur & Focus**: Logische Tab-Reihenfolge, focus-visible, Skip-Links, Focus-Trapping/-Rückgabe, roving tabindex Patterns
...
- **Medien & Motion**: Untertitel, Transkripte, Audiobeschreibung, Autoplay-Kontrolle, Motion-Reduction entsprechend Benutzerpräferenzen
...
- **Mobile & Touch**: Geräteunabhängige Eingaben, Gesten-Alternativen, Drag-Alternativen, Touch-Target-Sizing
