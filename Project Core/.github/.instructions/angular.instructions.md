...
## Projektkontext
- Neueste Angular-Version (standardmäßig Standalone Components verwenden)
- TypeScript für Type Safety
- Angular CLI für Projekt-Setup und Scaffolding
- Angular Style Guide befolgen (https://angular.dev/style-guide)
- Angular Material oder andere moderne UI-Bibliotheken für konsistentes Styling verwenden (falls spezifiziert)
