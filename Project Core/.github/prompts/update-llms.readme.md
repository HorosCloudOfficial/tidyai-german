...
## 📝 Beschreibung
GitHub Copilot Prompt für Update Llms-Funktionalität.

## 🚀 Verwendung
Automatisiert Update Llms-bezogene Aufgaben und Workflows.

## 💡 Beste Nutzung
Verwenden Sie diesen Prompt für effiziente Update Llms-Implementierung.

## 📋 Prompt-Details
- **Datei**: `update-llms.prompt.md`
...
Weitere Details finden Sie in der entsprechenden Prompt-Datei: `update-llms.prompt.md`
