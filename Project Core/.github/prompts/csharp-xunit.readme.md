...
## 📝 Beschreibung
GitHub Copilot Prompt für Csharp Xunit-Funktionalität.

## 🚀 Verwendung
Automatisiert Csharp Xunit-bezogene Aufgaben und Workflows.

## 💡 Beste Nutzung
Verwenden Sie diesen Prompt für effiziente Csharp Xunit-Implementierung.

## 📋 Prompt-Details
- **Datei**: `csharp-xunit.prompt.md`
...
Weitere Details finden Sie in der entsprechenden Prompt-Datei: `csharp-xunit.prompt.md`
