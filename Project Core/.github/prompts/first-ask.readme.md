...
## 📝 Beschreibung
GitHub Copilot Prompt für First Ask-Funktionalität.

## 🚀 Verwendung
Automatisiert First Ask-bezogene Aufgaben und Workflows.

## 💡 Beste Nutzung
Verwenden Sie diesen Prompt für effiziente First Ask-Implementierung.

## 📋 Prompt-Details
- **Datei**: `first-ask.prompt.md`
...
Weitere Details finden Sie in der entsprechenden Prompt-Datei: `first-ask.prompt.md`
