# ==============================================================================
# TIDYAI - BENUTZEROBERFLÄCHEN-FUNKTIONEN
# ==============================================================================
...
function Show-OrganizationTree {
    ...
    if ($Structure -and $Structure.Count -gt 0) {
        Write-ColorText "Vorgeschlagene Organisationsstruktur:" $Colors.Primary
        Write-Host ""
        ...
        for ($i = 0; $i -lt $Structure.Count; $i++) {
            ...
            Write-ColorText "$folderPrefix$emoji $($folder.folderName) ($($folder.items.Count) Dateien)" $Colors.Primary
        ...
        Write-ColorText "+-- Keine Reorganisation vorgeschlagen - Ordner ist bereits gut organisiert!" $Colors.Success
    }
